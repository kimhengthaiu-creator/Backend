...
export const LogoMark = ({ className = "w-8 h-8" }) => (
  <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
      d="M6 8C6 6.89543 6.89543 6 8 6H13C22.9411 6 31 14.0589 31 24C31 25.1046 30.1046 26 29 26H24C14.0589 26 6 17.9411 6 8Z"
      fill="#10B981"
    />
    <path
      d="M13 14C13 12.8954 13.8954 12 15 12H19C25.6274 12 31 17.3726 31 24C31 25.1046 30.1046 26 29 26H25C18.3726 26 13 20.6274 13 14Z"
      fill="#34D399"
    />
    <circle cx="12" cy="24" r="5" fill="#10B981" />
  </svg>
);
...
export const ModulesIcon = ({ className = "w-4 h-4" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const PlayIcon = ({ className = "w-4 h-4", filled = false }) => (
  <svg viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const CodeLabIcon = ({ className = "w-5 h-5" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 2v7.31L4.1 20.36A1.5 1.5 0 0 0 5.4 22.5h13.2a1.5 1.5 0 0 0 1.3-2.14L14 9.31V2" />
